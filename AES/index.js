...
const { toString } = require("./matrix.js");
...
for (let index = 0; index < aes.length; index++) {
  console.log((record = aes[index][0]));
  
  for (let subIndex = 1; subIndex < aes[index].length; subIndex++) {
    console.log(toString(aes[index][subIndex]), "\n");
  }
}
